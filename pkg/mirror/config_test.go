...
func TestRepoPoolConfig_ValidateDefaults(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid", args{dc: DefaultConfig{"/root", time.Second, "always", Auth{"/path/to/key", "/host"}}}, false},
		{"invalid_root", args{dc: DefaultConfig{"root", time.Second, "always", Auth{"/path/to/key", "/host"}}}, true},
		{"invalid_interval", args{dc: DefaultConfig{"/root", time.Millisecond, "always", Auth{"/path/to/key", "/host"}}}, true},
		{"valid_gc", args{dc: DefaultConfig{"/root", time.Second, "", Auth{"/path/to/key", "/host"}}}, false},
		{"invalid_gc", args{dc: DefaultConfig{"/root", time.Second, "blah", Auth{"/path/to/key", "/host"}}}, true},
	}
		...
		{"all_def",
			RepoPoolConfig{
				Defaults: DefaultConfig{
					"/root", time.Second, "always", Auth{"/path/to/key", "/host"},
				},
